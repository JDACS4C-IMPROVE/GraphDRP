# GraphDRP
GraphDRP is a Graph Convolutional Networks for Drug Response Prediction (DRP).


# Dependencies
Check here [conda_env_py37.sh](./conda_env_py37.sh)
...
+ [candle_lib](https://github.com/ECP-CANDLE/candle_lib)
