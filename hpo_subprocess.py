...
mpirun -np 5 python hpo_subprocess.py
"""
# import copy
import json
import subprocess
...
rank = comm.Get_rank()
size = comm.Get_size()
# local_rank = os.environ["PMI_LOCAL_RANK"]  # TODO. error here??
...
model_outdir = f"dh_hpo_improve/{source}/split_{split}"  # Leo
#log_dir = f"{source}_dh_hpo_logs/"
log_dir = "dh_hpo_logs/"  # Leo
...
if __name__ == "__main__":
    ...
    #       "; CUDA_VISIBLE_DEVICE is set to: ", os.environ["CUDA_VISIBLE_DEVICES"])
