...
def run(params: Dict):
    ...
    if 'SMILES' in smi.columns:
        ...
        smi = smi.iloc[:, :2]
        smi.columns = [params["drug_col_name"], 'SMILES']
    # Remove any rows from smi where "SMILES" is "F".
    smi = smi[smi["SMILES"] != "F"].reset_index(drop=True)
    ...
    #ge_scaler_fpath = "/raid/msacco/ws/GraphDRP/out.end_to_end_repurposing/preprocess/split_0/x_data_gene_expression_scaler.gz"
    ...
    stages = {"tcga_test": params["test_split_file"]}
...
def main(args):
    ...
    params = cfg.initialize_parameters(
        ...
        default_config="tcga_params.txt",
